...
$scope.productdetail=function(){
		    ...
		    .then(function(response) {
		           $scope.delProduct=response.data;
		...
		$scope.deleteProduct=function(pid){
			//alert($scope.dselectedProduct.pid);
			$http.get("../api/admin/DeleteProduct.php?pid="+pid)
		    .then(function(response) {
				...
				<div class="card" style="width: 50rem;">
					<div class="card-body">
						...
						<IMG HEIGHT=60PX WIDTH=60PX SRC="data:image/jpeg;base64,">	
							...
							<BR>
							 <select ng-model="dselectedProduct" ng-change="productdetail();"  ng-options="x.pname for x in products"    class="form-control"   >
								    <option>{{{{ x.cname }}}}</option>
								   </select>
							<BR>
							<BR>
							<IMG ALT="IMAGE HERE" ng-src="{{delProduct.image}}"  HEIGHT=128PX WIDTH=128PX  SRC="https://cdn0.iconfinder.com/data/icons/gray-business-toolbar/512/product-3-512.png"><BR><BR>
							<b>PRODUCT PID:</b> {{delProduct.pid}}<BR><BR>
						
							<b>PRODUCT NAME:</b> {{delProduct.pname}}<BR><BR>
							<b>PRODUCT CATEGORIES:</b> {{delProduct.cid}} <BR><BR>
							<b>PRODUCT PRICE:</b> {{delProduct.pprice}} <BR><BR>
							<b>PRODUCT AVAILABLE:</b> {{delProduct.pavailable}} <BR><BR>
							<b>PRODUCT DESCRIPTION:</b> {{delProduct.pdescription}} <BR><BR>
							 <button ng-click="deleteProduct(delProduct.pid)" type="button" class="btn btn-primary ">DELETE</button>
